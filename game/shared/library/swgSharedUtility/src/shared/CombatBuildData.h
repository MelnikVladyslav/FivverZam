...
#ifndef _INCLUDED_CombatBuildData_H
#define _INCLUDED_CombatBuildData_H
...
namespace ConfigCombatBuildData
{
	struct BodyAttackMod;
};

//-------------------------------------------------------------------
// CombatBuildData - data attached to every combatant

namespace CombatBuildData
{
	typedef std::vector<CachedNetworkId> TargetIdList;

	// results of a defense
	// NOTE: make sure CombatBuildData.cpp name-string table is updated when these values change.
	...
	//--------------------------------------------------
	// CombatBuildData inline functions
...
#endif	// _INCLUDED_CombatBuildData_H
